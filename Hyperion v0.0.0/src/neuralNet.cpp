...
/// </summary>
	...
	void neuralNet::addLayer(int inSize, int outSize, LayerType type, ActivationFunction activationType, int numFilters, int kernelFilterSize, int step, double dropoutRate) {
